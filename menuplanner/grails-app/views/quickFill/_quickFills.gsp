...
<div id="countrymenu">
    <ul>
        ...
        <li>
            <ul>
                <li><g:select name="day0" from="${QuickFill.list()}" optionKey="id" optionValue="${it}" class="mySelect"/> </li>
                <li><g:select name="day1" from="${QuickFill.list()}" optionKey="id" optionValue="${it}" class="mySelect"/></li>
                <li><g:select name="day2" from="${QuickFill.list()}" optionKey="id" optionValue="${it}" class="mySelect" /></li>
                <li><g:select name="day3" from="${QuickFill.list()}" optionKey="id" optionValue="${it}" class="mySelect"/></li>
                <li><g:select name="day4" from="${QuickFill.list()}" optionKey="id" optionValue="${it}" class="mySelect"/></li>
                <li><g:select name="day5" from="${QuickFill.list()}" optionKey="id" optionValue="${it}" class="mySelect"/></li>
              <li class="last"><g:select name="day6" from="${QuickFill.list()}" optionKey="id" optionValue="${it}" class="mySelect"/></li>
            </ul>
        </li>
