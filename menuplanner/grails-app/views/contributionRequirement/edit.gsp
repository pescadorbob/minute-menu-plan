      ...
      <div class="nav">
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${contributionRequirement?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="controllerName"><g:message code="contributionRequirement.controller.label" default="Controller Name" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: contributionRequirement, field: 'controllerName', 'errors')}">
                                    <g:textField name="controllerName" value="${contributionRequirement?.controllerName}" />
                                </td>
                            </tr>
