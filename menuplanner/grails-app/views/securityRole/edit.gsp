...
<div id="content-wrapper" class="clearfix">
    ...
    <div class="leftbox clearfix">
        ...
        <g:form name="editSecurityRoleForm" action="update" controller="securityRole" method="post" id="${role.id}">
            <div id="secureRole">
                <ul>
            ...
            <div id="button">
                <g:actionSubmit class="button" value="Update" controller="securityRole"/>
                <g:link action="show" id="${role.id}" name="editSecurityRole">
                    <input type="button" class="button" value="Cancel"/></g:link>
            </div>
        </g:form>
    </div>
