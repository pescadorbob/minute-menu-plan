...
class MasterDataBootStrapService implements ApplicationContextAware {
    ...
    public void populateAisle() {
        if (!Aisle.count()) {
            new Aisle(name: 'produce').s()
            new Aisle(name: 'frozen food').s()
            new Aisle(name: 'bulk food').s()
            new Aisle(name: 'baking').s()
            new Aisle(name: 'breads').s()
            new Aisle(name: 'meat and seafood').s()
            new Aisle(name: 'deli').s()
            new Aisle(name: 'bakery').s()
            new Aisle(name: 'dairy').s()
            new Aisle(name: 'pasta and rice').s()
            new Aisle(name: 'ethnic foods').s()
            new Aisle(name: 'canned foods').s()
            new Aisle(name: 'condiments').s()
            new Aisle(name: 'snacks').s()
            new Aisle(name: 'cereal').s()
            new Aisle(name: 'beverages').s()
            new Aisle(name: 'household items').s()
            new Aisle(name: 'health and beauty and or pharmacy').s()
        }
    }
