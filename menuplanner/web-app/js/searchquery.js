...
function submitSearchForm(element, fieldName, fieldValue) {
    ...
    if (fieldName == 'subCategoriesString') {
        if (element) {
            var categoryHtml = "<li><img onclick=\"removeSearchOptionFromCategoryList(this,'subCategoriesString','" + fieldValue + "')  src ='../images/delete-icon.jpg'/>Category: &nbsp; &nbsp; &nbsp;" + fieldValue + " </li>"
