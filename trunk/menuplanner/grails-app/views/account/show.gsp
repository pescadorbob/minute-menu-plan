            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="account.lastTransaction.label" default="Last Transaction" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${account?.lastTransaction}" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: account, field: "balance")}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: account, field: "accountNumber")}</td>
