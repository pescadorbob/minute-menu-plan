<tr class="directionRow">
    ...
    <td>
      ...
      <input class="DD" type="text" value="${direction}" name="dummyDirections" style="display:none;"/>      
    </td>
</tr>